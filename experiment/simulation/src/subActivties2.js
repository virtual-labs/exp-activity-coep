...
function subActivties2()
{
	...
	$("#Header").html("<center>Sub Activity-2 : Mark the activities in chronological sequence.</center>");
var htm=`
...
//	 +'</h5>'
	 ...
	 +' <h5 class="text-center" style="color: #297076;font-weight: 900;font-family: emoji;" id=""> 2. PREPARE DESIGN DOCUMENTS FOR THE PROJECT UNDER SCOPE</h5>'
...
<!-- 			  End Modal ProStr -->`;
		...
		$("#NextLevel").click(function () {
			resultJson.subActivties2Count=subActivties2Count;
			subActivties3();
		});
// Shuffle function
