...
function subActivties4()
{
	...
	$("#Header").html("<center>Sub Activity-4 : Mark the activities in chronological sequence.</center>");
var htm=`
...
`;
	 ...
	 function shuffleArray(array) {
        ...
        // Shuffle statements
        let shuffledData = shuffleArray([...subJsonData4.statements]);
...
//	 +'</h5>'
	 ...
	 +' <h5 class="text-center" style="    color: #297076;font-weight: 900;font-family: emoji;" id=""> 4. ESTIMATE THE ERECTION AND COMMISSIONING ACTIVITIES</h5>'
...
// Shuffle function
		$("#NextLevel").click(function () {
			resultJson.subActivties4Count=subActivties4Count;
			TimeVerifyCall();
		});
...
$(document).ready(function () {
    ...
    $('#verifyButton').click(function () {
        ...
        if (correctCount === subJsonData4.statements.length) {
		 ...
		 <table class="table table-striped" style="    margin-bottom: 100px;">
			    ...
			    <tbody id="dataTable">
				    ...
				    $("#diagram").html(htm);	
					 ...
					 subJsonData4.statements.forEach(function (item) {
            var row = `<tr>
                <td>${item.step_no}</td>
                <td>${item.statement}</td>
            </tr>`;
