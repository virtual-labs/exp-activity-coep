    ...
    var timeJson = {
    		  "activities": [
    		    {
    		      "section": "Activity 1 - Collect all latest versions of project documents ",
    		      "tasks": [
    		        {
    		          "activity_number": "a",
    		      ...
    		      "total_time": {
    		    	  "statement":"Total time required for Activity 1 in hours",
    		        "spray_dryer_with_utilities": 12,
    		        "flow_calibration_with_utilities": 7
    		      }
    		    },
    		    {
    		      "section": " Activity 2 - Prepare design documents for the project under scope",
    		      "tasks": [
    		        {
    		          "activity_number": "a",
    		      ...
    		      "total_time": {
    		    	  "statement":"Total time required for Activity 2 in hours",
    		        "spray_dryer_with_utilities": 105,
    		        "flow_calibration_with_utilities": 72
    		      }
    		    },
    		    {
    		      "section": "Activity 3 - Start the procurement in chronological sequence and based on long delivery time (long lead)",
    		      "tasks": [
    		        {
    		          "activity_number": "a",
    		      ...
    		      "total_time": {
    		    	  "statement":"Total time required for Activity 3 in hours",
    		        "spray_dryer_with_utilities": 270,
    		        "flow_calibration_with_utilities": 205
    		      }
    		    },
    		    {
    		      "section": "Activity 4 - Estimate the erection and commissioning activities (After the clearance from process team) ",
    		      "tasks": [
    		        {
    		          "activity_number": "a",
    		      ...
    		      "total_time": {
    		    	  "statement":"Total time required for Activity 4 in hours",
    		  ...
    		  "total_time_required2": {
    			  "statement":"Total time required for the project in hours",
