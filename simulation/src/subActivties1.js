...
//        let tableBody = $("#jsonTable tbody");
	...
	// +'<center><h5>FAULT OF EVENTS</h5></center>'
	 ...
	 +' <h5 class="text-center" style="    color: #297076;font-weight: 900;font-family: emoji;" id=""> 1. COLLECT ALL LATEST VERSIONS OF PROJECT DOCUMENTS</h5>'
...
<!-- 			  End Modal ProStr -->`;
		...
		$("#NextLevel").click(function () {
			resultJson.subActivties1Count=subActivties1Count;
			subActivties2();
		});
// Shuffle function
